...
def read_stock(config):
    ...
    # specify heat-pump 
    # skip this section if the building stock already distinguish the two types of HP
    if 'Electricity-Heat pump air' not in stock['Heating system']:
        repartition = 0.8
...
def read_inputs(config, other_inputs=generic_input):
    ...
    climate_model = config['climate_model']['climate_model']

...
def ini_res_irf(path=None, logger=None, config=None):
...
if __name__ == '__main__':
    buildings, energy_prices, taxes, cost_heater, cost_insulation, flow_built, post_inputs = ini_res_irf(path=None,
                                                                                                         logger=None,
                                                                                                         config=None)
